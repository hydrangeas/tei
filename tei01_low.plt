...
plot "tei01_low0.dat" using 1:4 title "Probability in number of trials(Xorshift)." w lp
replot "tei01_low1.dat" using 1:4 title "Probability in number of trials(MT)." w lp
...
plot "tei01_low0.dat" using 1:6 title "Probability in number of trials(Xorshift)." w lp
replot "tei01_low1.dat" using 1:6 title "Probability in number of trials(MT)." w lp
